package com.njznyq.wfCloudPlus.app.view;
...
import com.njznyq.wfCloudPlus.app.R;
...
public class WaveProgressView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null == getBackground()) {
            ...
            mBackground = getBitmapFromDrawable(getBackground());
        }
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            if (null != getBackground()) {
                height = getBackground().getMinimumHeight();
            } else {
                height = 400;
            }
        }
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            if (null != getBackground()) {
                width = getBackground().getMinimumWidth();
            } else {
                width = 400;
            }
        }
...
//                    getMeasuredHeight() / 2 + mTextRect.height() / 2, mTextPaint);
    ...
    private Bitmap createWaveBitmap(int width, int height) {
        ...
        for (int i = 0; i < mWaveCount; i++) {
            mPath.quadTo(i * mWaveWidth + mHalfWaveWidth - mDistance, mCurY - mWaveHeight,
                    i * mWaveWidth + mHalfWaveWidth * 2 - mDistance, mCurY);
            mPath.quadTo(i * mWaveWidth + mHalfWaveWidth * 3 - mDistance, mCurY + mWaveHeight,
                    i * mWaveWidth + mHalfWaveWidth * 4 - mDistance, mCurY);
        }
        ...
        mBackground = Bitmap.createScaledBitmap(mBackground, min, min, false);
